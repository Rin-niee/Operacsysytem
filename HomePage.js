...
const HomePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get('http://localhost:3000/'); // Убедитесь, что путь к вашему маршруту на сервере правильный
          ...
          <div key={item.id}>
            <div className='fon'>
              ...
              <div className='picture'>
                <img src={item.imageUrl} alt={item.name} style={{ width: '150px', height: '150px' }}/>
              </div>
